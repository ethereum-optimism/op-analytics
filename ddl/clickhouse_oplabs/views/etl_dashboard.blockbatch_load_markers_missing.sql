CREATE OR REPLACE VIEW etl_dashboard.blockbatch_load_markers_missing AS
...
, blockbatch_root_paths AS (
  ...
  FROM
    etl_monitor.blockbatch_markers_datawarehouse
)
...
LEFT ANTI JOIN observed_markers AS o USING (root_path, chain, dt, min_block)
