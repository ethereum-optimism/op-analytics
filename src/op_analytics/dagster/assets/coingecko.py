...
@asset
def token_metadata(context: OpExecutionContext):
    """Pull token metadata from CoinGecko."""
    from op_analytics.coreutils.path import repo_path
    from op_analytics.datasources.coingecko.execute import execute_metadata_pull
