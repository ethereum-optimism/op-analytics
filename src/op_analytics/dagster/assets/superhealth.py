...
@asset(deps=[
    dfl_stables_data_table_2de3f4f5,
    dune_all_txs_table_2bf9dc2d,
    all_chains_metadata_range_mv_table_d67ae33d,
    daily_growthepie_l2_activity_table_ec0a2bb5,
    daily_l2beat_l2_activity_table_891fbc3f,
    daily_defillama_chain_tvl_table_5e4e0e2c,
    activity_history_table_1dc2da3d,
    chain_summary_latest_table_a4add729,
    op_stack_chain_metadata_table_5fe3404a,
    tvl_history_table_e3de8abd,
    historical_chain_tvl_v1_table_12115837,
    dune_all_fees_table_f3b22c56,
    stablecoins_balances_v1_table_77f8a27b,
    chain_summary_latest_table_19755cb3,
    stablecoins_metadata_v1_table_03e6ece5,
    volume_fees_revenue_breakdown_v1_table_4e626584,
    dune_all_txs_table_eaa13223,
    view_daily_op_chains_usage,
    view_stablecoins_metadata_v1_latest_price,
    view_l2beat_daily_tvl_history
], metadata={
    "view_name": "view_daily_chain_usage_data",
    "asset_id": "view_daily_chain_usage_data",
    "direct_dependencies_count": 35,
...
def view_daily_chain_usage_data_min(context: OpExecutionContext):
    """
View: view_daily_chain_usage_data
Type: view
Direct dependencies: 35
