...
generally stick to daily data processing. For multi-chain datasets we also use the `chain` partition.
...
Legacy data ingestion processes at OP Labs write data directly to BigQuery. Using BigQuery is not as
