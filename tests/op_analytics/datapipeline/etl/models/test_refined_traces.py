...
class TestRefinedTraces001(ModelTestBase):
    ...
    def test_refined_txs_schema(self):
        ...
        assert actual_schema == {
            ...
            "legacy_extra_fee_per_gas": "DECIMAL(38,0)",
            "l2_fee": "DECIMAL(38,0)",
            "l2_priority_fee": "DECIMAL(38,0)",
            "l2_base_fee": "DECIMAL(38,0)",
            "method_id": "VARCHAR",
            "success": "BOOLEAN",
            ...
            "l1_gas_used_unified": "DECIMAL(38,0)",
            "tx_fee": "DECIMAL(38,0)",
            "l2_legacy_extra_fee": "DECIMAL(38,0)",
            "l1_base_fee": "DECIMAL(38,6)",
            "l1_base_scaled_size": "DECIMAL(38,6)",
            "l1_blob_fee": "DECIMAL(38,6)",
            "l1_blob_scaled_size": "DECIMAL(38,6)",
