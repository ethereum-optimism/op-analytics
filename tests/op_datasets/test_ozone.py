...
from op_datasets.processing.ozone import BatchOutputs, split_block_range


def test_path_01():
    br = BlockRange.from_spec("245156:+15000")
    actual = BatchOutputs(chain="op", dt="2024-10-03", block_range=br).construct_path("blocks")
