...
SELECT
  ...
  SUM(COALESCE(receipt_l1_gas_used, (receipt_l1_fee /(COALESCE(16*micro(receipt_l1_base_fee_scalar), receipt_l1_fee_scalar) * receipt_l1_gas_price + COALESCE(micro(receipt_l1_blob_base_fee_scalar) * receipt_l1_blob_base_fee, 0))))) AS total_l1_gas_used,
  
  SUM(IF(receipt_status = 1, COALESCE(receipt_l1_gas_used, (receipt_l1_fee /(COALESCE(16*micro(receipt_l1_base_fee_scalar), receipt_l1_fee_scalar) * receipt_l1_gas_price + COALESCE(micro(receipt_l1_blob_base_fee_scalar) * receipt_l1_blob_base_fee, 0)))), 0)) AS total_l1_gas_used_success,
