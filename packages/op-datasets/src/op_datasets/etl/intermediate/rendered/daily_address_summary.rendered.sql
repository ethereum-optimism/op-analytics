...
SELECT
  ...
  COUNT(DISTINCT datepart('hour', make_timestamp(block_timestamp::BIGINT * 1000000))) AS unique_hours_active,
  ...
  SUM(COALESCE(receipt_l1_gas_used, (receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0))))) AS total_l1_gas_used,
  
  SUM(IF(receipt_status = 1, COALESCE(receipt_l1_gas_used, (receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0)))), 0)) AS total_l1_gas_used_success,
  ...
  wei_to_eth(SUM((receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0))) * receipt_l1_blob_base_fee_scalar/1000000 * receipt_l1_blob_base_fee)) AS l1_contrib_contrib_gas_fees_blobgas,
  
  wei_to_eth(SUM((receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0))) * COALESCE(16*receipt_l1_base_fee_scalar/1000000, receipt_l1_fee_scalar) * receipt_l1_gas_price)) AS l1_contrib_gas_fees_l1gas,
  ...
  wei_to_gwei(safe_div(SUM((receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0))) * COALESCE(16*receipt_l1_base_fee_scalar/1000000, receipt_l1_fee_scalar) * receipt_l1_gas_price), SUM((receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0))) * COALESCE(16*receipt_l1_base_fee_scalar/1000000, receipt_l1_fee_scalar)))) AS avg_l1_gas_price_gwei,
  
  wei_to_gwei(safe_div(SUM((receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0))) * receipt_l1_blob_base_fee_scalar/1000000 * receipt_l1_blob_base_fee), SUM((receipt_l1_fee /(16*COALESCE(receipt_l1_fee_scalar,receipt_l1_base_fee_scalar)*receipt_l1_gas_price/1000000 + COALESCE( receipt_l1_blob_base_fee_scalar*receipt_l1_blob_base_fee/1000000 , 0))) * receipt_l1_blob_base_fee_scalar/1000000))) AS avg_l1_blob_base_fee_gwei,
  FROM
  transactions AS t
