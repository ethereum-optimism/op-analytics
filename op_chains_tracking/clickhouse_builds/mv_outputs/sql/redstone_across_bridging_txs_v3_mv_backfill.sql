INSERT INTO redstone_across_bridging_txs_v3_mv
...
from (
    select
        ...
        END AS integrator
        , l.insert_time
    from redstone_logs as l
    join redstone_transactions as t
    ...
    where 1=1
        AND l.block_timestamp BETWEEN '2024-09-12' AND '2024-09-13'
        AND t.block_timestamp BETWEEN '2024-09-12' AND '2024-09-13'
