...
data_df['blockchain'] = data_df['blockchain'].replace(chain_mappings)
...
# Post to Dune API
d.write_dune_api_from_pandas(data_df, 'opchain_used_contracts_creators_gs',\
                             'Basic Used Contracts Methodology for Zora & PGN (from Goldsky)')
